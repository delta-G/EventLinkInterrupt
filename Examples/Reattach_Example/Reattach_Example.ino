...
*
*      Wire a button between pin 7 and ground.
*      Pressing the button will detach the interrupt for 
*      the CAC overflow interrupt OVFI
*
*
*/
...
void loop() {
  ...
  if(buttonState != oldButtonState){
    ...
    if(buttonState == LOW){
      ...
      detachEventLinkInterrupt(ovfiEventLinkIndex);
    } else {
      // reattach event code 0x49 (OVFI) to the same vector from before
      reattachEventLinkInterrupt(0x49, ovfiEventLinkIndex);
    }
